...
public class URLVerifier {
    ...
    public URLVerifier(byte[] publicKey) throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeySpecException, IOException {
        this(KeyImporter.importPublicKey(publicKey));
    }

    public URLVerifier(String publicKey) throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeySpecException, IOException {
        this(KeyImporter.importPublicKey(publicKey));
    }

    public URLVerifier(File publicKeyFile) throws IOException, NoSuchAlgorithmException, NoSuchProviderException, InvalidKeySpecException {
        this(KeyImporter.importPublicKey(publicKeyFile));
    }

    private URLVerifier(PublicKey publicKey) throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeySpecException, IOException {
        key = publicKey;
    ...
    public boolean verify(URI uri) throws URISyntaxException, SignatureException, InvalidKeyException, ParseException {
    ...
    public boolean getVerification(byte[] message, byte[] signature) throws SignatureException, InvalidKeyException {
